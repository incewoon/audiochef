...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AudioChef is an offline-ready PWA that converts MP4 to MP3 right on your device." },
      { name: "author", content: "AudioChef" },
      { name: "theme-color", content: "#0f172a" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "AudioChef" },
      ...
      { name: "twitter:title", content: "AudioChef — MP4 to MP3 Converter" },
